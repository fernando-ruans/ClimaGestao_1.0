...
export function MobileMenu() {
  ...
  return (
    <div className="lg:hidden fixed top-0 left-0 w-full z-20">
      ...
      {isOpen && (
        <div className="absolute w-full bg-gradient-to-b from-blue-700 to-blue-900 border-b border-blue-700 shadow-lg">
          {/* Perfil do usuário */}
          ...
          <nav className="p-2">
            <ul className="grid grid-cols-1 gap-1">
              <li>
                <a href="/" 
                   className="flex items-center px-4 py-3 rounded-lg transition-colors bg-blue-800 text-white"
              ...
              <li>
                <a href="/services" 
                   className="flex items-center px-4 py-3 rounded-lg transition-colors bg-blue-800 text-white"
                   onClick={() => {window.location.href = "/services"; closeMenu();}}>
              ...
              <li>
                <a href="/clients" 
                   className="flex items-center px-4 py-3 rounded-lg transition-colors bg-blue-800 text-white"
                   onClick={() => {window.location.href = "/clients"; closeMenu();}}>
              ...
              <li>
                <a href="/quotes" 
                   className="flex items-center px-4 py-3 rounded-lg transition-colors bg-blue-800 text-white"
                   onClick={() => {window.location.href = "/quotes"; closeMenu();}}>
              ...
              <li>
                <a href="/work-orders" 
                   className="flex items-center px-4 py-3 rounded-lg transition-colors bg-blue-800 text-white"
                   onClick={() => {window.location.href = "/work-orders"; closeMenu();}}>
              ...
              {isAdmin && (
                <>
                  <li>
                    <a href="/users" 
                       className="flex items-center px-4 py-3 rounded-lg transition-colors bg-red-800 text-white"
                       onClick={() => {window.location.href = "/users"; closeMenu();}}>
                  ...
                  <li>
                    <a href="/settings" 
                       className="flex items-center px-4 py-3 rounded-lg transition-colors bg-red-800 text-white"
                       onClick={() => {window.location.href = "/settings"; closeMenu();}}>
