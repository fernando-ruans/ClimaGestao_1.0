...
export function setupAuth(app: Express) {
  const sessionSettings: session.SessionOptions = {
    ...
    cookie: {
      ...
      secure: false, // Desabilita secure para desenvolvimento
      sameSite: 'lax' // Para permitir requisições de diferentes origens
    }
  };
  ...
  app.post("/api/login", (req, res, next) => {
    passport.authenticate("local", (err: any, user: Express.User | undefined, info: { message: string } | undefined) => {
      if (err) {
